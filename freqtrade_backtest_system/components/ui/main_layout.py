    ...
    def render_navigation(self) -> str:
        ...
        if HAS_OPTION_MENU:
            selected = option_menu(
                menu_title=None,
                options=["Strategy Management", "Backtest Config", "Execution Monitor", "Results Analysis", "Jupyter Analysis", "Performance Monitor", "Installation Guide"],
                icons=["folder", "gear", "play-circle", "bar-chart", "journal-code", "speedometer2", "tools"],
                menu_icon="cast",
                default_index=0,
            ...
            selected = st.selectbox(
                "选择页面",
                ["Strategy Management", "Backtest Config", "Execution Monitor", "Results Analysis", "Jupyter Analysis", "Performance Monitor", "Installation Guide"],
                index=0
            )
        return selected
